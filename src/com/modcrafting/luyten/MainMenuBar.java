...
public class MainMenuBar extends JMenuBar {
    ...
    public static void searchall(final String searchstr, final FindAllBox findAll)
    {
        Thread tmp_thread = new Thread() {
            public void run() {
                ...
                try {
                    ...
                    Integer len = Collections.list(entLength).size();
                    findAll.initProgressBar(len);

                    Enumeration<JarEntry> ent = jfile.entries();
                    while (ent.hasMoreElements()) {
                        JarEntry entry = ent.nextElement();
                        findAll.setStatus(entry.getName());
