...
public class Model extends JSplitPane {
	...
	private final static LuytenTypeLoader typeLoader = new LuytenTypeLoader();
	...
	private void addOrSwitchToTab(OpenFile open) {
        //JOptionPane.showMessageDialog(null,open.scrollPane.getTextArea());
	...
	public String extractClassToString(TypeReference type) throws Exception {
    ...
    {
        JarEntry entry = state.jarFile.getJarEntry("flex/management/MBeanServerLocator.class");
        try {
